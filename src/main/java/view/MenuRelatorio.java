...
public class MenuRelatorio {
	...
	private static final int OPCAO_MENU_RELATORIO_TOTAL_DESPESAS_USUARIO_ABERTA_POR_PERIODO = 5;
	private static final int OPCAO_MENU_RELATORIO_SAIR = 6;

	public void apresentarMenuRelatrorio() {
		...
		while (opcao != OPCAO_MENU_RELATORIO_SAIR) {
			switch (opcao) {
			   ...
			   case OPCAO_MENU_RELATORIO_TOTAL_DESPESAS_USUARIO_ABERTA_POR_PERIODO: {
			...
			private int apresentarOpcoesMenu() {
				...
				System.out.println(OPCAO_MENU_RELATORIO_TOTAL_DESPESAS_USUARIO_ABERTA_POR_PERIODO + " - Relatório - Total de Despesas dos Usuários aberta por Período");
