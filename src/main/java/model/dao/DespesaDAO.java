...
public class DespesaDAO {
	...
	public boolean existeRegistroPorIdDespesa(int id) {
		...
		try {
			...
			System.out.println("\nErro ao executar a query que verifica  a existencia de registro por ID.");
			System.out.println("Erro: " + e.getMessage());
		}finally {
	...
	public int excluirDespesaDAO(DespesaVO despesaVO) {
		...
		try {
			...
			System.out.println("\nErro ao executar a query de exclusão de Despesa");
			System.out.println("Erro: " + e.getMessage());
		}finally {
			Banco.closeStatement(stmt);
			Banco.closeConnection(conn);
	...
	public ArrayList<DespesaVO> consultarTodasDespesasDAO(DespesaVO despesaVO) {
		...
		try {
			...
			System.out.println("\nErro ao executar a quer de consulta da lista de Despesas de um Usuário. ");
			System.out.println("Erro: " + e.getMessage());
		}finally {
			Banco.closeResultSet(resultado);
			Banco.closeStatement(stmt);
	...
	public DespesaVO consultarDespesaDAO(DespesaVO despesaVO) {
		...
		try {
			...
			System.out.println("\nErro ao executar a quer de consulta de uma Despesa. ");
			System.out.println("Erro: " + e.getMessage());
		}finally {
			Banco.closeResultSet(resultado);
			Banco.closeStatement(stmt);
